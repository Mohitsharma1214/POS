# Prompt for extracting virality patterns using Anthropic

from app.schemas.signal_collection_schema import ViralPatterns
import json

async def extract_virality_patterns(appearances, niche_videos, comments, twitter_narratives, reddit_discussions, llm_service):
    prompt = (
